...
private KinoplanerAsync kinoplaner = ClientsideSettings.getKinoplaner();
	...
	public void onLoad() {
		...
		/*kinoplaner.getVorstellungenBySpielplan(spielzeit1, new AsyncCallback<ArrayList<Vorstellung>>() {
			...
			public void onFailure(Throwable caught) {
				// TODO Auto-generated method stub
				Systemmeldung.anzeigen("Vorstellung für Spielzeit konnte nicht geladen werden");
			}

			@Override
			public void onSuccess(ArrayList<Vorstellung> vorstellung) {
				// TODO Auto-generated method stub
				
				for (Vorstellung a: vorstellung) {
					list.add(a);
				}
			}
	...
	private class VorstellungCallback implements AsyncCallback<Vorstellung> {
		...
		public void onFailure(Throwable caught) {
			// TODO Auto-generated method stub
			Systemmeldung.anzeigen("VorstellungsCallback funktioniert nicht");
...
private class SpielzeitSpeichernCallback implements AsyncCallback<Void> {
	...
	public void onSuccess(Void result) {
		...
		if (spielzeitnameTB.getValue() == "") {
			Systemmeldung.anzeigen("Es wurde keine Spielzeitname eingegeben");
		}else {
			
			RootPanel.get("detail").clear();
...
private class LoeschenSpielzeitCallback implements AsyncCallback<Void> {
