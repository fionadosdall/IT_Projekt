...
public class ErgebnisseAnzeigenForm extends FlowPanel {
	...
	public void onLoad() {
		...
		if (umfragen != null) {
			...
			felder.setWidget(1, 0, new Label("Keine Ergebnisse verfügbar."));
		}
		this.add(felder);
	...
	private class SucheErgebnisseByAnwenderCallback implements AsyncCallback<ArrayList<Umfrage>> {

		@Override
		public void onFailure(Throwable caught) {
			Window.alert("Ergebnis nicht abrufbar");
