...
/**
 * <P>
 * Die Klasse <code>BusinessObjekt</code> stellt die Basisklassen aller in
 * diesem Projekt fuer die Umsetzung des Fachkonzepts releanten Klassen da
 * </p>
 * <p>
 ...
 * <code>BusinessObjekt</code> automatisch in eine textuell Form uberfuehrt
 * werden z.B. zwischen Client und Server transportiert werden. Bei GWT RPC ist
 * diese textuelle Notation in JSON
 * </p>
 * 
 * @author fiona
 *
...
public abstract class BusinessObjekt implements Serializable {
	...
	/**
	 * Die eindeutige Identifikationsnummer einer Instanz dieser Klasse Das erstell
	 * Datum der Instanz Und der Name einer Instanz dieser Klasse
	 */
	...
	/**
	 * Erzeugen einer texutellen Darstellung der jeweiligen Instanz Kann in
